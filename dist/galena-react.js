...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["galena-react"] = {}));
...
function galenaHookFactory(stateFragment) {
  return function useGalenaState(connect) {
    var _useState = react.exports.useState(connect(stateFragment.state)),
        state = _useState[0],
...
var ContextFactory = /*#__PURE__*/function () {
  function ContextFactory(stateFragment) {
    ...
    this.Context = react.exports.createContext(stateFragment.state);
