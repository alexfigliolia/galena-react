...
export default defineConfig([
  ...
  {
    input: "src/index.ts",
    output: { file: "lib/galena-react.js", format: "cjs", indent: false },
    external,
    plugins: [
      nodeResolve({
        extensions,
  ...
  {
    input: "src/index.ts",
    output: { file: "es/galena-react.js", format: "es", indent: false },
    external,
    plugins: [
      nodeResolve({
        extensions,
  ...
  {
    input: "src/index.ts",
    output: { file: "es/galena-react.mjs", format: "es", indent: false },
    plugins: [
      nodeResolve({
        extensions,
      }),
